...
const CropSathiPrefs = (() => {
  ...
  const translations = {
    en: {
      ...
      mf_title: 'My Fields', mf_loading: 'Loading your fields...', mf_no_fields: 'No fields yet', mf_no_fields_desc: 'Add your first field to start tracking crop health and yield.', mf_add_field: 'Add New Field', mf_add_first: 'Add Your First Field', mf_view_details: 'View Details', mf_search_fields: 'Search fields...',
    ...
    hi: {
      ...
      mf_title: 'मेरे खेत', mf_loading: 'आपके खेत लोड हो रहे हैं...', mf_no_fields: 'अभी तक कोई खेत नहीं', mf_no_fields_desc: 'फसल स्वास्थ्य और उपज ट्रैक करने के लिए अपना पहला खेत जोड़ें।', mf_add_field: 'नया खेत जोड़ें', mf_add_first: 'अपना पहला खेत जोड़ें', mf_view_details: 'विवरण देखें', mf_search_fields: 'खेत खोजें...',
    ...
    mr: {
      ...
      mf_title: 'माझे शेत', mf_loading: 'तुमची शेत लोड होत आहे...', mf_no_fields: 'अजून कोणतीही शेत नाही', mf_no_fields_desc: 'पिकांचे आरोग्य आणि उत्पादन ट्रॅक करण्यासाठी तुमचे पहिले शेत जोडा.', mf_add_field: 'नवीन शेत जोडा', mf_add_first: 'तुमचे पहिले शेत जोडा', mf_view_details: 'तपशील पहा', mf_search_fields: 'शेत शोधा...',
    ...
    bn: {
      ...
      mf_title: 'আমার জমি', mf_loading: 'আপনার জমি লোড হচ্ছে...', mf_no_fields: 'এখনো কোনো জমি নেই', mf_no_fields_desc: 'ফসল ট্র্যাক করতে আপনার প্রথম জমি যোগ করুন।', mf_add_field: 'নতুন জমি যোগ করুন', mf_add_first: 'প্রথম জমি যোগ করুন', mf_view_details: 'বিস্তারিত দেখুন', mf_search_fields: 'জমি খুঁজুন...',
    ...
    te: {
      ...
      mf_title: 'నా పొలాలు', mf_loading: 'మీ పొలాలు లోడ్ అవుతున్నాయి...', mf_no_fields: 'ఇంకా పొలాలు లేవు', mf_no_fields_desc: 'పంటను ట్రాక్ చేయడానికి మీ మొదటి పొలాన్ని జోడించండి.', mf_add_field: 'కొత్త పొలాన్ని జోడించండి', mf_add_first: 'మొదటి పొలాన్ని జోడించండి', mf_view_details: 'వివరాలు చూడండి', mf_search_fields: 'పొలాలను వెతకండి...',
